...
class SubdomainFinderTakeover:
    ...
    def check_takeover_vulnerability(self, subdomain):
        ...
        try:
            ...
            if vulnerability_detected:
                ...
                print(f"\033[93m[!] Potential {result['confidence']} confidence takeover vulnerability found in {subdomain} ({result['service']})\033[0m")
                return result
    ...
    def run(self, input_file=None):
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            future_to_subdomain = {executor.submit(self.check_takeover_vulnerability, subdomain): subdomain for subdomain in self.subdomains}
